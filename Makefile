...
COMM_HDR    = alloc-inl.h config.h debug.h types.h peri-mod.h
...
afl-gerr: afl-gerr.c $(COMM_HDR) | test_x86
	$(CC) $(CFLAGS) $@.c -o $@ $(LDFLAGS)

afl-fuzz_no_timeout: afl-fuzz_no_timeout.c $(COMM_HDR) | test_x86
	$(CC) $(CFLAGS) $@.c -o $@ $(LDFLAGS)
